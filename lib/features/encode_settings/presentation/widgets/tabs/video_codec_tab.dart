    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          AppDropdown<VideoProfile>(
            label: l10n.videoProfile,
            value: c.videoProfile,
            items: c.availableVideoProfiles,
            itemLabel: (profile) => profile.value ?? l10n.automatic,
            onChanged: c.setVideoProfile,
            enabled: c.supportsProfileLevel,
          ),
          const SizedBox(height: 16),
          AppDropdown<VideoLevel>(
            label: l10n.videoLevel,
            value: c.videoLevel,
            items: VideoLevel.values,
            itemLabel: (level) => level.value ?? l10n.automatic,
            onChanged: c.setVideoLevel,
            enabled: c.supportsProfileLevel,
          ),
          const SizedBox(height: 16),
          AppDropdown<PixelFormat>(
            label: l10n.pixelFormat,
            value: c.pixelFormat,
            items: PixelFormat.values,
            itemLabel: (format) => format.value ?? l10n.automatic,
            onChanged: c.setPixelFormat,
          ),
          const SizedBox(height: 16),
          AppDropdown<ToneMapMode>(
            label: l10n.hdrToneMapping,
            value: c.toneMapMode,
            items: ToneMapMode.values,
            itemLabel: (mode) => switch (mode) {
              ToneMapMode.off => l10n.off,
              ToneMapMode.hable => 'Hable',
              ToneMapMode.reinhard => 'Reinhard',
              ToneMapMode.mobius => 'Mobius',
            },
            onChanged: c.setToneMapMode,
          ),
          const SizedBox(height: 16),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
