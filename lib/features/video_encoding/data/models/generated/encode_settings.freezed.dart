...
mixin _$EncodeSettings {
 ...
 VideoEncoder get codec; EncoderMode get encoderMode; EncodePreset get preset; VideoProfile get videoProfile; VideoLevel get videoLevel; PixelFormat get pixelFormat; double? get frameRate; ToneMapMode get toneMapMode; int get crf; OutputExtension get outputExtension;/// Null = keep original resolution. Format: "1920:1080".
 String? get resolution; AudioCodec get audioCodec; AudioBitrate get audioBitrate; AudioChannelMode get audioChannels; AudioSampleRate get audioSampleRate; bool get normalizeAudio; double get audioGainDb; bool get preserveAllAudioTracks; List<TextOverlay> get textOverlays; bool get embedTimestampSubtitle; bool get preserveSourceSubtitles;/// Template for output file name (without extension). Empty = default
...
/// empty = keep original, no crop.
 ...
 Deinterlace get deinterlace; QualityMode get qualityMode; int get avgBitrateKbps; int get targetSizeMb; bool get twoPass; bool get turboFirstPass;/// Raw extra params forwarded via codec-specific flag (e.g. `-x265-params`).
...
/// Apple cameras. Null = fall back to the encoding machine's local TZ.
 String? get sourceTimezoneOffset; bool get webOptimized; Rotation get rotation;/// When true and [rotation] != none, write rotation as display metadata
/// only (no pixel re-encode). Best with MP4/MOV containers.
 bool get useDisplayRotation; bool get flipHorizontal; bool get flipVertical;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EncodeSettings&&(identical(other.codec, codec) || other.codec == codec)&&(identical(other.encoderMode, encoderMode) || other.encoderMode == encoderMode)&&(identical(other.preset, preset) || other.preset == preset)&&(identical(other.videoProfile, videoProfile) || other.videoProfile == videoProfile)&&(identical(other.videoLevel, videoLevel) || other.videoLevel == videoLevel)&&(identical(other.pixelFormat, pixelFormat) || other.pixelFormat == pixelFormat)&&(identical(other.frameRate, frameRate) || other.frameRate == frameRate)&&(identical(other.toneMapMode, toneMapMode) || other.toneMapMode == toneMapMode)&&(identical(other.crf, crf) || other.crf == crf)&&(identical(other.outputExtension, outputExtension) || other.outputExtension == outputExtension)&&(identical(other.resolution, resolution) || other.resolution == resolution)&&(identical(other.audioCodec, audioCodec) || other.audioCodec == audioCodec)&&(identical(other.audioBitrate, audioBitrate) || other.audioBitrate == audioBitrate)&&(identical(other.audioChannels, audioChannels) || other.audioChannels == audioChannels)&&(identical(other.audioSampleRate, audioSampleRate) || other.audioSampleRate == audioSampleRate)&&(identical(other.normalizeAudio, normalizeAudio) || other.normalizeAudio == normalizeAudio)&&(identical(other.audioGainDb, audioGainDb) || other.audioGainDb == audioGainDb)&&(identical(other.preserveAllAudioTracks, preserveAllAudioTracks) || other.preserveAllAudioTracks == preserveAllAudioTracks)&&const DeepCollectionEquality().equals(other.textOverlays, textOverlays)&&(identical(other.embedTimestampSubtitle, embedTimestampSubtitle) || other.embedTimestampSubtitle == embedTimestampSubtitle)&&(identical(other.preserveSourceSubtitles, preserveSourceSubtitles) || other.preserveSourceSubtitles == preserveSourceSubtitles)&&(identical(other.outputNameTemplate, outputNameTemplate) || other.outputNameTemplate == outputNameTemplate)&&(identical(other.cropAspectRatio, cropAspectRatio) || other.cropAspectRatio == cropAspectRatio)&&(identical(other.deinterlace, deinterlace) || other.deinterlace == deinterlace)&&(identical(other.qualityMode, qualityMode) || other.qualityMode == qualityMode)&&(identical(other.avgBitrateKbps, avgBitrateKbps) || other.avgBitrateKbps == avgBitrateKbps)&&(identical(other.targetSizeMb, targetSizeMb) || other.targetSizeMb == targetSizeMb)&&(identical(other.twoPass, twoPass) || other.twoPass == twoPass)&&(identical(other.turboFirstPass, turboFirstPass) || other.turboFirstPass == turboFirstPass)&&(identical(other.extraParams, extraParams) || other.extraParams == extraParams)&&(identical(other.copySourceMetadata, copySourceMetadata) || other.copySourceMetadata == copySourceMetadata)&&(identical(other.sourceTimezoneOffset, sourceTimezoneOffset) || other.sourceTimezoneOffset == sourceTimezoneOffset)&&(identical(other.webOptimized, webOptimized) || other.webOptimized == webOptimized)&&(identical(other.rotation, rotation) || other.rotation == rotation)&&(identical(other.useDisplayRotation, useDisplayRotation) || other.useDisplayRotation == useDisplayRotation)&&(identical(other.flipHorizontal, flipHorizontal) || other.flipHorizontal == flipHorizontal)&&(identical(other.flipVertical, flipVertical) || other.flipVertical == flipVertical));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,codec,encoderMode,preset,videoProfile,videoLevel,pixelFormat,frameRate,toneMapMode,crf,outputExtension,resolution,audioCodec,audioBitrate,audioChannels,audioSampleRate,normalizeAudio,audioGainDb,preserveAllAudioTracks,const DeepCollectionEquality().hash(textOverlays),embedTimestampSubtitle,preserveSourceSubtitles,outputNameTemplate,cropAspectRatio,deinterlace,qualityMode,avgBitrateKbps,targetSizeMb,twoPass,turboFirstPass,extraParams,copySourceMetadata,sourceTimezoneOffset,webOptimized,rotation,useDisplayRotation,flipHorizontal,flipVertical]);

@override
String toString() {
  return 'EncodeSettings(codec: $codec, encoderMode: $encoderMode, preset: $preset, videoProfile: $videoProfile, videoLevel: $videoLevel, pixelFormat: $pixelFormat, frameRate: $frameRate, toneMapMode: $toneMapMode, crf: $crf, outputExtension: $outputExtension, resolution: $resolution, audioCodec: $audioCodec, audioBitrate: $audioBitrate, audioChannels: $audioChannels, audioSampleRate: $audioSampleRate, normalizeAudio: $normalizeAudio, audioGainDb: $audioGainDb, preserveAllAudioTracks: $preserveAllAudioTracks, textOverlays: $textOverlays, embedTimestampSubtitle: $embedTimestampSubtitle, preserveSourceSubtitles: $preserveSourceSubtitles, outputNameTemplate: $outputNameTemplate, cropAspectRatio: $cropAspectRatio, deinterlace: $deinterlace, qualityMode: $qualityMode, avgBitrateKbps: $avgBitrateKbps, targetSizeMb: $targetSizeMb, twoPass: $twoPass, turboFirstPass: $turboFirstPass, extraParams: $extraParams, copySourceMetadata: $copySourceMetadata, sourceTimezoneOffset: $sourceTimezoneOffset, webOptimized: $webOptimized, rotation: $rotation, useDisplayRotation: $useDisplayRotation, flipHorizontal: $flipHorizontal, flipVertical: $flipVertical)';
}
...
@useResult
$Res call({
 VideoEncoder codec, EncoderMode encoderMode, EncodePreset preset, VideoProfile videoProfile, VideoLevel videoLevel, PixelFormat pixelFormat, double? frameRate, ToneMapMode toneMapMode, int crf, OutputExtension outputExtension, String? resolution, AudioCodec audioCodec, AudioBitrate audioBitrate, AudioChannelMode audioChannels, AudioSampleRate audioSampleRate, bool normalizeAudio, double audioGainDb, bool preserveAllAudioTracks, List<TextOverlay> textOverlays, bool embedTimestampSubtitle, bool preserveSourceSubtitles, String outputNameTemplate, String? cropAspectRatio, Deinterlace deinterlace, QualityMode qualityMode, int avgBitrateKbps, int targetSizeMb, bool twoPass, bool turboFirstPass, String extraParams, bool copySourceMetadata, String? sourceTimezoneOffset, bool webOptimized, Rotation rotation, bool useDisplayRotation, bool flipHorizontal, bool flipVertical
});
...
/// Create a copy of EncodeSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? codec = null,Object? encoderMode = null,Object? preset = null,Object? videoProfile = null,Object? videoLevel = null,Object? pixelFormat = null,Object? frameRate = freezed,Object? toneMapMode = null,Object? crf = null,Object? outputExtension = null,Object? resolution = freezed,Object? audioCodec = null,Object? audioBitrate = null,Object? audioChannels = null,Object? audioSampleRate = null,Object? normalizeAudio = null,Object? audioGainDb = null,Object? preserveAllAudioTracks = null,Object? textOverlays = null,Object? embedTimestampSubtitle = null,Object? preserveSourceSubtitles = null,Object? outputNameTemplate = null,Object? cropAspectRatio = freezed,Object? deinterlace = null,Object? qualityMode = null,Object? avgBitrateKbps = null,Object? targetSizeMb = null,Object? twoPass = null,Object? turboFirstPass = null,Object? extraParams = null,Object? copySourceMetadata = null,Object? sourceTimezoneOffset = freezed,Object? webOptimized = null,Object? rotation = null,Object? useDisplayRotation = null,Object? flipHorizontal = null,Object? flipVertical = null,}) {
  return _then(_self.copyWith(
codec: null == codec ? _self.codec : codec // ignore: cast_nullable_to_non_nullable
as VideoEncoder,encoderMode: null == encoderMode ? _self.encoderMode : encoderMode // ignore: cast_nullable_to_non_nullable
as EncoderMode,preset: null == preset ? _self.preset : preset // ignore: cast_nullable_to_non_nullable
as EncodePreset,videoProfile: null == videoProfile ? _self.videoProfile : videoProfile // ignore: cast_nullable_to_non_nullable
as VideoProfile,videoLevel: null == videoLevel ? _self.videoLevel : videoLevel // ignore: cast_nullable_to_non_nullable
as VideoLevel,pixelFormat: null == pixelFormat ? _self.pixelFormat : pixelFormat // ignore: cast_nullable_to_non_nullable
as PixelFormat,frameRate: freezed == frameRate ? _self.frameRate : frameRate // ignore: cast_nullable_to_non_nullable
as double?,toneMapMode: null == toneMapMode ? _self.toneMapMode : toneMapMode // ignore: cast_nullable_to_non_nullable
as ToneMapMode,crf: null == crf ? _self.crf : crf // ignore: cast_nullable_to_non_nullable
...
as AudioBitrate,audioChannels: null == audioChannels ? _self.audioChannels : audioChannels // ignore: cast_nullable_to_non_nullable
as AudioChannelMode,audioSampleRate: null == audioSampleRate ? _self.audioSampleRate : audioSampleRate // ignore: cast_nullable_to_non_nullable
as AudioSampleRate,normalizeAudio: null == normalizeAudio ? _self.normalizeAudio : normalizeAudio // ignore: cast_nullable_to_non_nullable
as bool,audioGainDb: null == audioGainDb ? _self.audioGainDb : audioGainDb // ignore: cast_nullable_to_non_nullable
as double,preserveAllAudioTracks: null == preserveAllAudioTracks ? _self.preserveAllAudioTracks : preserveAllAudioTracks // ignore: cast_nullable_to_non_nullable
as bool,textOverlays: null == textOverlays ? _self.textOverlays : textOverlays // ignore: cast_nullable_to_non_nullable
as List<TextOverlay>,embedTimestampSubtitle: null == embedTimestampSubtitle ? _self.embedTimestampSubtitle : embedTimestampSubtitle // ignore: cast_nullable_to_non_nullable
as bool,preserveSourceSubtitles: null == preserveSourceSubtitles ? _self.preserveSourceSubtitles : preserveSourceSubtitles // ignore: cast_nullable_to_non_nullable
as bool,outputNameTemplate: null == outputNameTemplate ? _self.outputNameTemplate : outputNameTemplate // ignore: cast_nullable_to_non_nullable
...
as int,targetSizeMb: null == targetSizeMb ? _self.targetSizeMb : targetSizeMb // ignore: cast_nullable_to_non_nullable
...
as bool,rotation: null == rotation ? _self.rotation : rotation // ignore: cast_nullable_to_non_nullable
as Rotation,useDisplayRotation: null == useDisplayRotation ? _self.useDisplayRotation : useDisplayRotation // ignore: cast_nullable_to_non_nullable
as bool,flipHorizontal: null == flipHorizontal ? _self.flipHorizontal : flipHorizontal // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VideoEncoder codec,  EncoderMode encoderMode,  EncodePreset preset,  VideoProfile videoProfile,  VideoLevel videoLevel,  PixelFormat pixelFormat,  double? frameRate,  ToneMapMode toneMapMode,  int crf,  OutputExtension outputExtension,  String? resolution,  AudioCodec audioCodec,  AudioBitrate audioBitrate,  AudioChannelMode audioChannels,  AudioSampleRate audioSampleRate,  bool normalizeAudio,  double audioGainDb,  bool preserveAllAudioTracks,  List<TextOverlay> textOverlays,  bool embedTimestampSubtitle,  bool preserveSourceSubtitles,  String outputNameTemplate,  String? cropAspectRatio,  Deinterlace deinterlace,  QualityMode qualityMode,  int avgBitrateKbps,  int targetSizeMb,  bool twoPass,  bool turboFirstPass,  String extraParams,  bool copySourceMetadata,  String? sourceTimezoneOffset,  bool webOptimized,  Rotation rotation,  bool useDisplayRotation,  bool flipHorizontal,  bool flipVertical)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EncodeSettings() when $default != null:
return $default(_that.codec,_that.encoderMode,_that.preset,_that.videoProfile,_that.videoLevel,_that.pixelFormat,_that.frameRate,_that.toneMapMode,_that.crf,_that.outputExtension,_that.resolution,_that.audioCodec,_that.audioBitrate,_that.audioChannels,_that.audioSampleRate,_that.normalizeAudio,_that.audioGainDb,_that.preserveAllAudioTracks,_that.textOverlays,_that.embedTimestampSubtitle,_that.preserveSourceSubtitles,_that.outputNameTemplate,_that.cropAspectRatio,_that.deinterlace,_that.qualityMode,_that.avgBitrateKbps,_that.targetSizeMb,_that.twoPass,_that.turboFirstPass,_that.extraParams,_that.copySourceMetadata,_that.sourceTimezoneOffset,_that.webOptimized,_that.rotation,_that.useDisplayRotation,_that.flipHorizontal,_that.flipVertical);case _:
  return orElse();
...
class _EncodeSettings extends EncodeSettings {
  const _EncodeSettings({this.codec = VideoEncoder.h264, this.encoderMode = EncoderMode.software, this.preset = EncodePreset.veryfast, this.videoProfile = VideoProfile.auto, this.videoLevel = VideoLevel.auto, this.pixelFormat = PixelFormat.auto, this.frameRate, this.toneMapMode = ToneMapMode.off, this.crf = 23, this.outputExtension = OutputExtension.mp4, this.resolution, this.audioCodec = AudioCodec.passthrough, this.audioBitrate = AudioBitrate.k128, this.audioChannels = AudioChannelMode.source, this.audioSampleRate = AudioSampleRate.source, this.normalizeAudio = false, this.audioGainDb = 0, this.preserveAllAudioTracks = true, final  List<TextOverlay> textOverlays = const [], this.embedTimestampSubtitle = false, this.preserveSourceSubtitles = false, this.outputNameTemplate = '', this.cropAspectRatio, this.deinterlace = Deinterlace.off, this.qualityMode = QualityMode.crf, this.avgBitrateKbps = 4000, this.targetSizeMb = 100, this.twoPass = false, this.turboFirstPass = false, this.extraParams = '', this.copySourceMetadata = true, this.sourceTimezoneOffset, this.webOptimized = true, this.rotation = Rotation.none, this.useDisplayRotation = false, this.flipHorizontal = false, this.flipVertical = false}): _textOverlays = textOverlays,super._();
...
@override@JsonKey() final  EncoderMode encoderMode;
@override@JsonKey() final  EncodePreset preset;
@override@JsonKey() final  VideoProfile videoProfile;
@override@JsonKey() final  VideoLevel videoLevel;
@override@JsonKey() final  PixelFormat pixelFormat;
@override final  double? frameRate;
@override@JsonKey() final  ToneMapMode toneMapMode;
...
@override@JsonKey() final  AudioChannelMode audioChannels;
@override@JsonKey() final  AudioSampleRate audioSampleRate;
@override@JsonKey() final  bool normalizeAudio;
@override@JsonKey() final  double audioGainDb;
@override@JsonKey() final  bool preserveAllAudioTracks;
...
@override@JsonKey() final  bool embedTimestampSubtitle;
@override@JsonKey() final  bool preserveSourceSubtitles;
...
@override@JsonKey() final  int targetSizeMb;
...
@override@JsonKey() final  Rotation rotation;
/// When true and [rotation] != none, write rotation as display metadata
/// only (no pixel re-encode). Best with MP4/MOV containers.
@override@JsonKey() final  bool useDisplayRotation;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EncodeSettings&&(identical(other.codec, codec) || other.codec == codec)&&(identical(other.encoderMode, encoderMode) || other.encoderMode == encoderMode)&&(identical(other.preset, preset) || other.preset == preset)&&(identical(other.videoProfile, videoProfile) || other.videoProfile == videoProfile)&&(identical(other.videoLevel, videoLevel) || other.videoLevel == videoLevel)&&(identical(other.pixelFormat, pixelFormat) || other.pixelFormat == pixelFormat)&&(identical(other.frameRate, frameRate) || other.frameRate == frameRate)&&(identical(other.toneMapMode, toneMapMode) || other.toneMapMode == toneMapMode)&&(identical(other.crf, crf) || other.crf == crf)&&(identical(other.outputExtension, outputExtension) || other.outputExtension == outputExtension)&&(identical(other.resolution, resolution) || other.resolution == resolution)&&(identical(other.audioCodec, audioCodec) || other.audioCodec == audioCodec)&&(identical(other.audioBitrate, audioBitrate) || other.audioBitrate == audioBitrate)&&(identical(other.audioChannels, audioChannels) || other.audioChannels == audioChannels)&&(identical(other.audioSampleRate, audioSampleRate) || other.audioSampleRate == audioSampleRate)&&(identical(other.normalizeAudio, normalizeAudio) || other.normalizeAudio == normalizeAudio)&&(identical(other.audioGainDb, audioGainDb) || other.audioGainDb == audioGainDb)&&(identical(other.preserveAllAudioTracks, preserveAllAudioTracks) || other.preserveAllAudioTracks == preserveAllAudioTracks)&&const DeepCollectionEquality().equals(other._textOverlays, _textOverlays)&&(identical(other.embedTimestampSubtitle, embedTimestampSubtitle) || other.embedTimestampSubtitle == embedTimestampSubtitle)&&(identical(other.preserveSourceSubtitles, preserveSourceSubtitles) || other.preserveSourceSubtitles == preserveSourceSubtitles)&&(identical(other.outputNameTemplate, outputNameTemplate) || other.outputNameTemplate == outputNameTemplate)&&(identical(other.cropAspectRatio, cropAspectRatio) || other.cropAspectRatio == cropAspectRatio)&&(identical(other.deinterlace, deinterlace) || other.deinterlace == deinterlace)&&(identical(other.qualityMode, qualityMode) || other.qualityMode == qualityMode)&&(identical(other.avgBitrateKbps, avgBitrateKbps) || other.avgBitrateKbps == avgBitrateKbps)&&(identical(other.targetSizeMb, targetSizeMb) || other.targetSizeMb == targetSizeMb)&&(identical(other.twoPass, twoPass) || other.twoPass == twoPass)&&(identical(other.turboFirstPass, turboFirstPass) || other.turboFirstPass == turboFirstPass)&&(identical(other.extraParams, extraParams) || other.extraParams == extraParams)&&(identical(other.copySourceMetadata, copySourceMetadata) || other.copySourceMetadata == copySourceMetadata)&&(identical(other.sourceTimezoneOffset, sourceTimezoneOffset) || other.sourceTimezoneOffset == sourceTimezoneOffset)&&(identical(other.webOptimized, webOptimized) || other.webOptimized == webOptimized)&&(identical(other.rotation, rotation) || other.rotation == rotation)&&(identical(other.useDisplayRotation, useDisplayRotation) || other.useDisplayRotation == useDisplayRotation)&&(identical(other.flipHorizontal, flipHorizontal) || other.flipHorizontal == flipHorizontal)&&(identical(other.flipVertical, flipVertical) || other.flipVertical == flipVertical));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,codec,encoderMode,preset,videoProfile,videoLevel,pixelFormat,frameRate,toneMapMode,crf,outputExtension,resolution,audioCodec,audioBitrate,audioChannels,audioSampleRate,normalizeAudio,audioGainDb,preserveAllAudioTracks,const DeepCollectionEquality().hash(_textOverlays),embedTimestampSubtitle,preserveSourceSubtitles,outputNameTemplate,cropAspectRatio,deinterlace,qualityMode,avgBitrateKbps,targetSizeMb,twoPass,turboFirstPass,extraParams,copySourceMetadata,sourceTimezoneOffset,webOptimized,rotation,useDisplayRotation,flipHorizontal,flipVertical]);
...
/// Create a copy of EncodeSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? codec = null,Object? encoderMode = null,Object? preset = null,Object? videoProfile = null,Object? videoLevel = null,Object? pixelFormat = null,Object? frameRate = freezed,Object? toneMapMode = null,Object? crf = null,Object? outputExtension = null,Object? resolution = freezed,Object? audioCodec = null,Object? audioBitrate = null,Object? audioChannels = null,Object? audioSampleRate = null,Object? normalizeAudio = null,Object? audioGainDb = null,Object? preserveAllAudioTracks = null,Object? textOverlays = null,Object? embedTimestampSubtitle = null,Object? preserveSourceSubtitles = null,Object? outputNameTemplate = null,Object? cropAspectRatio = freezed,Object? deinterlace = null,Object? qualityMode = null,Object? avgBitrateKbps = null,Object? targetSizeMb = null,Object? twoPass = null,Object? turboFirstPass = null,Object? extraParams = null,Object? copySourceMetadata = null,Object? sourceTimezoneOffset = freezed,Object? webOptimized = null,Object? rotation = null,Object? useDisplayRotation = null,Object? flipHorizontal = null,Object? flipVertical = null,}) {
...
as bool,audioGainDb: null == audioGainDb ? _self.audioGainDb : audioGainDb // ignore: cast_nullable_to_non_nullable
as double,preserveAllAudioTracks: null == preserveAllAudioTracks ? _self.preserveAllAudioTracks : preserveAllAudioTracks // ignore: cast_nullable_to_non_nullable
as bool,textOverlays: null == textOverlays ? _self._textOverlays : textOverlays // ignore: cast_nullable_to_non_nullable
as List<TextOverlay>,embedTimestampSubtitle: null == embedTimestampSubtitle ? _self.embedTimestampSubtitle : embedTimestampSubtitle // ignore: cast_nullable_to_non_nullable
as bool,preserveSourceSubtitles: null == preserveSourceSubtitles ? _self.preserveSourceSubtitles : preserveSourceSubtitles // ignore: cast_nullable_to_non_nullable
as bool,outputNameTemplate: null == outputNameTemplate ? _self.outputNameTemplate : outputNameTemplate // ignore: cast_nullable_to_non_nullable
as String,cropAspectRatio: freezed == cropAspectRatio ? _self.cropAspectRatio : cropAspectRatio // ignore: cast_nullable_to_non_nullable
