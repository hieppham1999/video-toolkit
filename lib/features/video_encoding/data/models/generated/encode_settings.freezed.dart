...
mixin _$EncodeSettings {
 ...
 String? get resolution; AudioCodec get audioCodec; AudioBitrate get audioBitrate; bool get preserveAllAudioTracks; List<TextOverlay> get textOverlays; bool get embedTimestampSubtitle; bool get preserveSourceSubtitles;/// Template for output file name (without extension). Empty = default
...
as AudioBitrate,preserveAllAudioTracks: null == preserveAllAudioTracks ? _self.preserveAllAudioTracks : preserveAllAudioTracks // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,codec,encoderMode,preset,videoProfile,videoLevel,pixelFormat,frameRate,toneMapMode,crf,outputExtension,resolution,audioCodec,audioBitrate,preserveAllAudioTracks,const DeepCollectionEquality().hash(_textOverlays),embedTimestampSubtitle,preserveSourceSubtitles,outputNameTemplate,cropAspectRatio,deinterlace,qualityMode,avgBitrateKbps,targetSizeMb,twoPass,turboFirstPass,extraParams,copySourceMetadata,sourceTimezoneOffset,webOptimized,rotation,useDisplayRotation,flipHorizontal,flipVertical]);
