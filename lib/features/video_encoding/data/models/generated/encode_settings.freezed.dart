...
mixin _$EncodeSettings {
 ...
 String? get resolution; AudioCodec get audioCodec; AudioBitrate get audioBitrate; List<TextOverlay> get textOverlays; bool get embedTimestampSubtitle;/// Template for output file name (without extension). Empty = default
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,codec,encoderMode,preset,crf,outputExtension,resolution,audioCodec,audioBitrate,const DeepCollectionEquality().hash(textOverlays),embedTimestampSubtitle,outputNameTemplate,cropAspectRatio,deinterlace,qualityMode,avgBitrateKbps,targetSizeMb,twoPass,turboFirstPass,extraParams,copySourceMetadata,sourceTimezoneOffset,webOptimized,rotation,useDisplayRotation,flipHorizontal,flipVertical]);

@override
String toString() {
  return 'EncodeSettings(codec: $codec, encoderMode: $encoderMode, preset: $preset, crf: $crf, outputExtension: $outputExtension, resolution: $resolution, audioCodec: $audioCodec, audioBitrate: $audioBitrate, textOverlays: $textOverlays, embedTimestampSubtitle: $embedTimestampSubtitle, outputNameTemplate: $outputNameTemplate, cropAspectRatio: $cropAspectRatio, deinterlace: $deinterlace, qualityMode: $qualityMode, avgBitrateKbps: $avgBitrateKbps, targetSizeMb: $targetSizeMb, twoPass: $twoPass, turboFirstPass: $turboFirstPass, extraParams: $extraParams, copySourceMetadata: $copySourceMetadata, sourceTimezoneOffset: $sourceTimezoneOffset, webOptimized: $webOptimized, rotation: $rotation, useDisplayRotation: $useDisplayRotation, flipHorizontal: $flipHorizontal, flipVertical: $flipVertical)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,codec,encoderMode,preset,crf,outputExtension,resolution,audioCodec,audioBitrate,const DeepCollectionEquality().hash(_textOverlays),embedTimestampSubtitle,outputNameTemplate,cropAspectRatio,deinterlace,qualityMode,avgBitrateKbps,targetSizeMb,twoPass,turboFirstPass,extraParams,copySourceMetadata,sourceTimezoneOffset,webOptimized,rotation,useDisplayRotation,flipHorizontal,flipVertical]);
